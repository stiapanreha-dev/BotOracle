...
class AIClient:
    ...
    def _hardcoded_admin_prompt(self, age: int, has_subscription: bool = False, free_chat: bool = False,
        ...
        if free_chat:
            ...
            selling_guide = """- ВАЖНО: Пользователь БЕЗ подписки - плавно подталкивай его к покупке подписки на Оракула
- В каждом 2-3 ответе упоминай ценность подписки (доступ к мудрости Оракула, глубокие ответы на важные вопросы)
- Когда вопрос становится глубоким/личным/философским - предлагай подписку как решение
- Используй мягкие формулировки: "Оракул помог бы тебе глубже разобраться", "Такой вопрос достоин мудрости Оракула", "С подпиской ты получишь доступ к настоящим ответам"
- Подчеркивай что бесплатных вопросов ограниченное количество (5 штук)
- НЕ будь навязчивой, но будь настойчивой и последовательной"""
            task_description = "помочь пользователю и мягко, но настойчиво продать подписку на Оракула"
